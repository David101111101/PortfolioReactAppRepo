...
The project demonstrates practical projects designing and developing a business system integrating authentication, inventory management, sales operations, analytics, and role-based access control backed by a relational database.
...
This thesis project informs stronger automation design because tests can be aligned with how systems actually behave internally, not only through UI interaction.
...
By building full-stack systems improves the ability to:
